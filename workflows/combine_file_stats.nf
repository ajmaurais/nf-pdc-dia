...
include { CALCULATE_FILE_STATS as SPECLIB_FILE_STATS } from "../nf-submodules/modules/s3"
include { CALCULATE_FILE_STATS as FASTA_FILE_STATS } from "../nf-submodules/modules/s3"
include { GZIP_FILE as GZIP_MZML } from "../nf-submodules/modules/s3"
...
workflow combine_file_stats {
    ...
    main:
        ...
        file_stats = GZIP_MZML.out.map{
            it -> tuple(it[0], "${s3_directory}/mzml", it[2], it[0].size())
        }.concat(
